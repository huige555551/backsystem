...
public class ActivityUserServie{
	 ...
	 * @throws XueWenServiceException 
	 ...
	 public ActivityUser add(ActivityUser user) throws XueWenServiceException{
		 ...
		 if(findByIdAndPhone(user.getActivityId(),user.getPhone())!=null){
			 throw new XueWenServiceException(Config.STATUS_201, "不能重复报名",null);
		 }
	...
	public ActivityUser findByIdAndPhone(String activity,String phone){
		return activityUserRepo.findByActivityIdAndPhone(activity,phone);
	}
