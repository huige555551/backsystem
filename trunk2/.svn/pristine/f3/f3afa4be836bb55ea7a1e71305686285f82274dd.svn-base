...
public class TopicResponse {
	...
	private boolean authorGroup;//是否有权限置顶
	...
	public TopicResponse(Topic topic){
		...
		this.setWeightSort(topic.getWeightSort());
		this.setDisplayTime(topic.getDisplayTime());
		this.setTagNames(topic.getTagNames());
		this.setSourceLogoUrl(topic.getSourceLogoUrl());
	}
	...
	public boolean isAuthorGroup() {
		return authorGroup;
	}


	public void setAuthorGroup(boolean authorGroup) {
