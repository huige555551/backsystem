...
public class GroupCourseService {
	 ...
	 * @throws
	 */
	public List<GroupCourse> findByCourseIn(List<String> courseIds) {
		return groupCourseRepository.findByCourseIn(courseIds);
	}
	 ...
	 * @throws
	 */
	public void coursesToSharesPc(String groupId, String courseIds, User user) throws XueWenServiceException {
		if (org.apache.commons.lang.StringUtils.isBlank(groupId)) {
			throw new XueWenServiceException(Config.STATUS_201,Config.MSG_201,null);
		}
		//选择的课程不为空时
		if (org.apache.commons.lang.StringUtils.isNotBlank(courseIds)) {
			String[] courseIdArray = courseIds.split(",");
			for (String courseId : courseIdArray) {
				shareCourseToGroupClassPc(groupId, courseId, user);
			}
		} 
	}
	 ...
	 * 
	 * @auther tangli
	 * @Description: 通过课程Id查找第一个群课程
	 * @param courseId
	 * @return NewGroupCourse
	 * @Date:2015年4月28日
	 * @throws
	 */
	public NewGroupCourse findOneByCourseId(String courseId) {
		return groupCourseRepository.findOneByCourse(courseId);
	}
