...
public interface GroupRepository extends MongoRepository<XueWenGroup, String> {
	...
	Page<XueWenGroup> findByIdNotIn(List<Object> myGroups,Pageable page);
	...
	List<XueWenGroup> findByMemberIn(String id);
	...
	Page<XueWenGroup> findByChildCategoryIdAndIdNotIn(
			String category, List<Object> ids, Pageable pageable);
