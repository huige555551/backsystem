...
public class OssIndexService {
	 ...
	 * @throws
	 */
	public List<JSONObject> findIndexDry(String name)
			throws XueWenServiceException {
	 ...
	 * @throws
	 */
	public List<JSONObject> findIndexGroups(String name)
			throws XueWenServiceException {
		List<Object> ids = getSourceIdByBoxPostName(name);
	 ...
	 * @throws
	 */
	public List<JSONObject> findIndexTopics(String name)
			throws XueWenServiceException {
		List<Object> ids = getSourceIdByBoxPostName(name);
	 ...
	 * @throws
	 */
	public List<JSONObject> findIndexCourse(String name)
			throws XueWenServiceException {
		List<Object> ids = getSourceIdByBoxPostName(name);
