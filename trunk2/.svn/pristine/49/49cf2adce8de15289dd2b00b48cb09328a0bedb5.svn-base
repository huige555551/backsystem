...
public class ZtiaoPushService {
	...
	public void sendRemoveGroup(String fromUserId,String fromUserNickName,String fromUserLogoUrl,String toUserId,
			String groupId,String groupName,String groupLogoUrl)throws Exception{
		ZtiaoPush zp=new ZtiaoPush("", "", Config.PUSH_REMOVEGROUP_TYPE,fromUserId,fromUserNickName,fromUserLogoUrl,
				toUserId,groupId,groupName,groupLogoUrl,null,"","","");
		rabbitmqService.sendPushMessage(zp);
	}
	/**
	...
	public void sendInviteInGroup(String fromUserId,String fromUserNickName,String fromUserLogoUrl,String toUserId,
		...
		ZtiaoPush zp=new ZtiaoPush("", "", Config.PUSH_INVITEINGROUP_TYPE,fromUserId,fromUserNickName,fromUserLogoUrl,
				toUserId,groupId,groupName,groupLogoUrl,openFireGroup,"","","");
		rabbitmqService.sendPushMessage(zp);
	}
	...
	public void sendApply(String fromUserId,String fromUserNickName,String fromUserLogoUrl,String toUserId)throws Exception{
		ZtiaoPush zp=new ZtiaoPush("", "", Config.PUSH_APPLYUSER_TYPE,fromUserId,fromUserNickName,fromUserLogoUrl,toUserId,"","","",
				null,"","","");
		rabbitmqService.sendPushMessage(zp);
	}
	...
	public void sendTopicPostOrSubPost(String pushType,String fromUserId,String fromUserNickName,String fromUserLogoUrl,String toUserId,
			String groupId,String groupName,String groupLogoUrl,String topicId,String title)throws Exception{
		ZtiaoPush zp=new ZtiaoPush("", "", pushType,fromUserId,fromUserNickName,fromUserLogoUrl,
				toUserId,groupId,groupName,groupLogoUrl,null,topicId,title,"");
		rabbitmqService.sendPushMessage(zp);
	}
...
//	}
	 ...
	 * @throws Exception
	 */
	public void sendApplyActivity(String toUserId,String groupId,String groupName,String groupLogoUrl,String activityId,String activityName)throws Exception{
		ZtiaoPush zp=new ZtiaoPush("", "", Config.PUSH_APPLYACTIVITY_TYPE,"","","",
				toUserId,groupId,groupName,groupLogoUrl,null,activityId,activityName,"");
		rabbitmqService.sendPushMessage(zp);
	}
