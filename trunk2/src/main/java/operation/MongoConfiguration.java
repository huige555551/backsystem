...
public class MongoConfiguration {
	...
	//	return new SimpleMongoDbFactory(new Mongo("s1.of.yunxuetang.com"), "test");
		...
		ServerAddress address1 = new ServerAddress(env.getProperty("mongo.service"), 27017);
	...
	//	addresses.add(address2);
		...
		return new SimpleMongoDbFactory(mongoClient5, env.getProperty("mongo.database"));
	}
