...
public class DrycargoResponse {
	...
	public DrycargoResponse(Drycargo dry){
		...
		this.setIsOriginal(dry.getIsOriginal());
		this.setDisplayOrder(dry.getDisplayOrder());
		this.setDisplayTime(dry.getDisplayTime());
		this.setGroupLogoUrl(dry.getGroupLogoUrl());
		this.setImages(dry.getImages());
		this.setContext(dry.getContext());
