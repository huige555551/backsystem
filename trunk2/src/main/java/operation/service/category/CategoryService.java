...
public class CategoryService {
	 ...
	 * @throws XueWenServiceException
	 */
	public List<Object> formateSecondList(List<Category> categorys, String type,String groupId) throws XueWenServiceException {
		if (categorys == null || StringUtil.isBlank(type)) {
			throw new XueWenServiceException(Config.STATUS_201, Config.MSG_PROPERTIESERROR_201, null);
		}
		List<Object> objs = new ArrayList<Object>();
		for (Category category : categorys) {
			objs.add(formateSecond(category, type,groupId));
		}
		return objs;
	}
	 ...
	 * @throws XueWenServiceException
	 */
	public Object formateSecond(Category category, String type,String groupId) throws XueWenServiceException {
		if (category != null && category.getCategoryType().equals(Config.CATEGORY_SENCOND)) {
			// 根据type值添加相应的统计数据
			int secondCountNum = getSecondCountNumByType(type, category.getId(),groupId);
			Map<String, Object> addAndModifyMap = new HashMap<String, Object>();
	 ...
	 * @throws XueWenServiceException
	 */
	public int getSecondCountNumByType(String type, String secondCategoryId,String groupId) throws XueWenServiceException {
			...
			// 课程池课程
			return newCourseService.countCheckedCourseByChildCategoryId(secondCategoryId,groupId);
		} else if (type.equals(Config.TYPE_GROUP)) {
			// 群组
