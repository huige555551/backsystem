package operation.service.jpush1;
...
@Component
@Configuration
public class JPushService1 {
	private static final Logger logger=Logger.getLogger(JPushService1.class);
	...
	public JPushClient getJPushClient()throws XueWenServiceException{
		JPushClient jpush =new JPushClient(env.getProperty("jpush1.masterSecret"), env.getProperty("jpush1.appKey"));
...
//		JPushClient jpush =new JPushClient("9f7b00454fb809af0cb04fe4","1cac47eac2defe6e1a36eff4");
	...
	public void sendToUser(String machine,String msg,String alia){
		try {
...
//			throw new XueWenServiceException(Config.STATUS_201,Config.MSG_PUSHFAIL_201,null);
	 ...
	 * @throws XueWenServiceException
	 */
	public void sendNotice(String machine,List<String> alias,String notice,Map<String,String> extras){
		try {
...
//			throw new XueWenServiceException(Config.STATUS_201,Config.MSG_PUSHFAIL_201,null);
	 ...
	 * @throws XueWenServiceException
	 */
	public void sendNoticeAndMsg(List<String> alias,String notice,String msg,Map<String,String> extras){
		try {
...
//			throw new XueWenServiceException(Config.STATUS_201,Config.MSG_PUSHFAIL_201,null);
	 ...
	 * @throws XueWenServiceException
	 */
	public void sendNoticeAndMsg(String alias,String notice,String msg,Map<String,String> extras){
		try {
			PushPayload ppl=buildPushObject_all_alias_alertAndMsg(alias,notice,msg,extras);
			getJPushClient().sendPush(ppl);
		} catch (Exception e) {
...
//			throw new XueWenServiceException(Config.STATUS_201,Config.MSG_PUSHFAIL_201,null);
	 ...
	 * @throws XueWenServiceException
	 */
	public void sendToTagsNoticeAndMsg(List<String> tags,String notice,String msg,Map<String,String> extras){
		try {
...
//			throw new XueWenServiceException(Config.STATUS_201,Config.MSG_PUSHFAIL_201,null);
	...
	public static void main(String[] args) {
			...
			JPushService1 jp=new JPushService1();
