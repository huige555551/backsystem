...
public class GroupDynamicService {
	...
	@Value("${groupDynamic.allDynamic.url137}")
	private String allDynamicUrl137;
	...
	public 	Page<GroupDynamic> getDynamic(String groupId,Pageable pageable,long time,String dynamic)throws XueWenServiceException{
		if("1".equals(dynamic)){
			return groupDynamicRepository.findByGroupIdAndCtimeGreaterThanAndCheckedAndTypeNot(groupId, time, true, Config.TYPE_ACTIVITY_GROUP, pageable);
		}else{
			return groupDynamicRepository.findByGroupIdAndCtimeLessThanAndCheckedAndTypeNot(groupId, time, true, Config.TYPE_ACTIVITY_GROUP, pageable);
		}
	}
	/**
	 * 获取动态
	 ...
	 * @throws XueWenServiceException
	 */
	public 	Page<GroupDynamic> getDynamic137(String groupId,Pageable pageable,long time,String dynamic)throws XueWenServiceException{
		if("1".equals(dynamic)){
	...
	public  JSONObject getAllGroupDynamics137(String token ,String ctime,String dynamic)throws XueWenServiceException{
		try {
			Map<String,String> map=new HashMap<String, String>();
			map.put("token", token);
			map.put("ctime", ctime);
			...
			map.put("s", "30");
			RestfulTemplateUtil restfulTemplateUtil=new RestfulTemplateUtil();
			return restfulTemplateUtil.getRestApiData(allDynamicUrl137, map);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			return null;
		}
	 ...
	 * @throws XueWenServiceException
	 */
	public Page<GroupDynamic> myCreateCourse137(String userId,String type,String liveType, Pageable pageable)throws XueWenServiceException{
		return groupDynamicRepository.findByAutherIdAndTypeOrAutherIdAndType(userId,type,userId, liveType,pageable);
	}
	/**
	 * 查询我创建的动态
	 * @param pageable
