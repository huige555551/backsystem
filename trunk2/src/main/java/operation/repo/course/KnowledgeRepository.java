...
public interface KnowledgeRepository extends MongoRepository<Knowledge, String> {
	...
	Page<Knowledge>findByIdInAndStatusAndCcodeAndRealTime(List<String> ids,int status,int ccode,boolean realTime,Pageable pageable);
...
//			int knowledgeCcodeOk);
	...
	Page<Knowledge> findByArcGreaterThanAndStatusAndCcodeAndNameRegexOrDescRegexOrTagNamesRegexAndRealTime(
			int i, int knowledgeStatPass, int knowledgeCcodeOk,
			String keyWords, String keyWords2, String keyWords3,boolean realTime,Pageable pageable);

	Page<Knowledge> findByArcGreaterThanAndStatusAndCcodeAndRealTime(int i,
			int knowledgeStatPass, int knowledgeCcodeOk,boolean realTime,Pageable pageable);
