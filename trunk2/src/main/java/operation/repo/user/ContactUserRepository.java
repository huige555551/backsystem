...
public interface ContactUserRepository extends MongoRepository<ContactUser,String>{
	...
	//搜索我的好友
	Page<ContactUser> findByToUserInAndFromUserAndStatusLessThan(List<String> toUsers,String userId,int status,Pageable pageable);
	//互相关注
	...
	int countByFromUserAndToUser(String id, String userId);
	int countByToUser(String userId);
	
	List<ContactUser> findAllByFromUser(String fromUser);
	List<ContactUser> findAllByToUser(String toUser);
