...
//	Page<Topic> findBySourceIdAndIsDeleted(String sourceId,boolean isDeleted,Pageable pageable);
	...
	List<Topic> findByIsDeletedAndPicUrlNotNullAndImagesIsNull(boolean isDeleted);
	...
	Page<Topic> findByIsDeletedAndChildCategoryIdAndTopicIdNotIn(boolean isdeleted,String childCategory,List<Object> topicIds,Pageable pageable);
	}
