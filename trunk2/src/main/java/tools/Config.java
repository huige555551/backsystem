...
//    public static final String QRCODE_TEMPORARY="/Users/hjn/Downloads/yxt/zxingtest";
	...
	public final static String TYPE_ACTIVITY_GROUP="45"; //活动
	public final static String TYPE_LIVE_GROUP="46"; //直播
	...
	public final static String PUSH_NEWBUYCOURSE_TYPE="24";//有购买新的课程
	public final static String PUSH_APPLYACTIVITY_TYPE="25";//活动报名
...
//	public final static String LIKE_TYPE_DIM="1";//递减
	...
	public static String ORDER_CREATE_URL="order/createActivity";
	...
	public static String COUPON_ALL_ACTIVITY="coupon/findAllActivity";
	public static String COUPON_EXTRACT="coupon/quota/extract";
	/**
	 * 更新信息类型
	 */
	public static String UPDATE_TYPE_GROUP="0";//更新信息类型-群组
	public static String UPDATE_TYPE_USER="1";//更新信息类型-用户
	/**
	 * 推荐系统路径
	 */
	
	public static String FIND_DATA="dry/findByuseid";
	public static String FIND_GROUP="dry/findGroupByuseid";
	
	public static String DRYCARGOCONTEXT="http://www.ztiao.cn/Group/";
	public static String DRYCARGOPATH="/DrycargoSelf/";
	public static String DRYCARGOVIEW ="/View";
	
	
	/**
	 * 评论数类型
	 */
	public final static String POSTNUM_TYPE_TOPIC = "P00";    			//基础话题回复数类型
	public final static String POSTNUM_TYPE_GROUPTOPIC= "P01";    		//群组话题回复数类型
	public final static String POSTNUM_TYPE_TOPICPOST = "P02";    		//基础话题主楼评论数类型
	public final static String POSTNUM_TYPE_GROUPTOPICPOST = "P03";    //群组话题主楼评论数类型
	public final static String POSTNUM_TYPE_COURSE = "P10";    			//基础课程评论数类型
	public final static String POSTNUM_TYPE_GROUPCOURSE = "P11";    	//群组课程评论数类型
	public final static String POSTNUM_TYPE_DRYCARGO = "P20";   			//基础干货评论数类型
	public final static String POSTNUM_TYPE_DRYCARGO_GROUP = "P21";    	//群组干货评论数类型
	public final static String POSTNUM_TYPE_KNOWLEDGE = "P30";    		//基础分享评论数类型
	public final static String POSTNUM_TYPE_GROUPKNOWLEDGE = "P31";    	//群组分享评论数类型
	public final static String POSTNUM_TYPE_XUANYE = "P40";    			//基础炫页评论数类型
	public final static String POSTNUM_TYPE_GROUPXUANYE= "P41";    	//群组炫页评论数类型
	public final static String POSTNUM_TYPE_GROUPDYNAMIC= "P50";    	//群组动态评论数类型
	/**
	 * 点赞数类型
	 */
	public final static String LIKENUM_TYPE_TOPIC = "L00";    			//基础话题点赞数类型
	public final static String LIKENUM_TYPE_GROUPTOPIC= "L01";    		//群组话题点赞数类型
	public final static String LIKENUM_TYPE_TOPICPOST = "L02";    		//基础话题主楼点赞数类型
	public final static String LIKENUM_TYPE_GROUPTOPICPOST = "L03";    //群组话题主楼点赞数类型
	public final static String LIKENUM_TYPE_COURSE = "L10";    			//基础课程点赞数类型
	public final static String LIKENUM_TYPE_GROUPCOURSE = "L11";    	//群组课程点赞数类型
	public final static String LIKENUM_TYPE_DRYCARGO = "L20";   			//基础干货点赞数类型
	public final static String LIKENUM_TYPE_DRYCARGO_GROUP = "L21";    	//群组干货点赞数类型
	public final static String LIKENUM_TYPE_KNOWLEDGE = "L30";    		//基础分享点赞数类型
	public final static String LIKENUM_TYPE_GROUPKNOWLEDGE = "L31";    	//群组分享点赞数类型
	public final static String LIKENUM_TYPE_XUANYE = "L40";    			//基础炫页点赞数类型
	public final static String LIKENUM_TYPE_GROUPXUANYE= "L41";    	//群组炫页点赞数类型
	public final static String LIKENUM_TYPE_GROUPDYNAMIC= "L50";    	//群组动态点赞数类型
	/**
	 * 不赞数类型
	 */
	public final static String UNLIKENUM_TYPE_TOPIC = "UL00";    			//基础话题不赞数类型
	public final static String UNLIKENUM_TYPE_GROUPTOPIC= "UL01";    		//群组话题不赞数类型
	public final static String UNLIKENUM_TYPE_TOPICPOST = "UL02";    		//基础话题主楼不赞数类型
	public final static String UNLIKENUM_TYPE_GROUPTOPICPOST = "UL03";    //群组话题主楼不赞数类型
	public final static String UNLIKENUM_TYPE_COURSE = "UL10";    			//基础课程不赞数类型
	public final static String UNLIKENUM_TYPE_GROUPCOURSE = "UL11";    	//群组课程不赞数类型
	public final static String UNLIKENUM_TYPE_DRYCARGO = "UL20";   			//基础干货不赞数类型
	public final static String UNLIKENUM_TYPE_DRYCARGO_GROUP = "UL21";    	//群组干货不赞数类型
	public final static String UNLIKENUM_TYPE_KNOWLEDGE = "UL30";    		//基础分享不赞数类型
	public final static String UNLIKENUM_TYPE_GROUPKNOWLEDGE = "UL31";    	//群组分享不赞数类型
	public final static String UNLIKENUM_TYPE_XUANYE = "UL40";    			//基础炫页不赞数类型
	public final static String UNLIKENUM_TYPE_GROUPXUANYE= "UL41";    	//群组炫页不赞数类型
	public final static String UNLIKENUM_TYPE_GROUPDYNAMIC= "UL50";    	//群组动态不赞数类型
	/**
	 * 收藏数类型
	 */
	public final static String FAVNUM_TYPE_TOPIC = "F00";    			//基础话题收藏数类型
	public final static String FAVNUM_TYPE_GROUPTOPIC= "F01";    		//群组话题收藏数类型
	public final static String FAVNUM_TYPE_TOPICPOST = "F02";    		//基础话题主楼收藏数类型
	public final static String FAVNUM_TYPE_GROUPTOPICPOST = "F03";    //群组话题主楼收藏数类型
	public final static String FAVNUM_TYPE_COURSE = "F10";    			//基础课程收藏数类型
	public final static String FAVNUM_TYPE_GROUPCOURSE = "F11";    	//群组课程收藏数类型
	public final static String FAVNUM_TYPE_DRYCARGO = "F20";   			//基础干货收藏数类型
	public final static String FAVNUM_TYPE_DRYCARGO_GROUP = "F21";    	//群组干货收藏数类型
	public final static String FAVNUM_TYPE_KNOWLEDGE = "F30";    		//基础分享收藏数类型
	public final static String FAVNUM_TYPE_GROUPKNOWLEDGE = "F31";    	//群组分享收藏数类型
	public final static String FAVNUM_TYPE_XUANYE = "F40";    			//基础炫页收藏数类型
	public final static String FAVNUM_TYPE_GROUPXUANYE= "F41";    	//群组炫页收藏数类型
	public final static String FAVNUM_TYPE_GROUPDYNAMIC= "F50";    	//群组动态收藏数类型
	
	/**
	 * 分享数类型
	 */
	public final static String SHARENUM_TYPE_TOPIC = "S00";    			//基础话题分享数类型
	public final static String SHARENUM_TYPE_GROUPTOPIC= "S01";    		//群组话题分享数类型
	public final static String SHARENUM_TYPE_TOPICPOST = "S02";    		//基础话题主楼分享数类型
	public final static String SHARENUM_TYPE_GROUPTOPICPOST = "S03";    //群组话题主楼分享数类型
	public final static String SHARENUM_TYPE_COURSE = "S10";    			//基础课程分享数类型
	public final static String SHARENUM_TYPE_GROUPCOURSE = "S11";    	//群组课程分享数类型
	public final static String SHARENUM_TYPE_DRYCARGO = "S20";   			//基础干货分享数类型
	public final static String SHARENUM_TYPE_DRYCARGO_GROUP = "S21";    	//群组干货分享数类型
	public final static String SHARENUM_TYPE_KNOWLEDGE = "S30";    		//基础分享分享数类型
	public final static String SHARENUM_TYPE_GROUPKNOWLEDGE = "S31";    	//群组分享分享数类型
	public final static String SHARENUM_TYPE_XUANYE = "S40";    			//基础炫页分享数类型
	public final static String SHARENUM_TYPE_GROUPXUANYE= "S41";    	//群组炫页分享数类型
	public final static String SHARENUM_TYPE_GROUPDYNAMIC= "S50";    	//群组动态分享数类型
	
	/**
	 * 动态操作类型
	 */
	public final static String DYNAMIC_DELETE_BYGROUPANDSOURCE="deleteByGroupAndSource";
	public final static String DYNAMIC_ADD_ADD="add";
	 ...
	 * 
	 */
	public final static String OPENFIRE_USER_CREATE="createUser";
	public final static String OPENFIRE_USER_LOCK="lockUser";
	public final static String OPENFIRE_GROUP_CREATE="createGROUP";
	public final static String OPENFIRE_GROUP_DESTROY="destroyGroup";
	 ...
	 * 
	 */
	public final static int LIVE_TYPE_VH=1;
	public final static int LIVE_TYPE_KK=0;
	
	public final static String LIVE_URL_VHSTART="e.vhall.com/";
	public final static String LIVE_URL_KKSTART="";
